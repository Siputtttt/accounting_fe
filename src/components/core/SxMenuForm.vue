...
<template>
	...
	<div class="mb-4">
		...
		<div class="d-flex justify-content-start gap-3">
			<div class="form-check">
				<input class="form-check-input" type="radio" name="type" id="radioDefault1" v-model="form.menu_type"
					value="internal" />
				<label class="form-check-label" for="radioDefault1"> Internal </label>
			</div>
			<div class="form-check">
				<input class="form-check-input" type="radio" name="type" id="radioDefault2" v-model="form.menu_type"
					value="external" />
	...
	<div class="mb-4">
		...
		<v-select :options="modules" v-model="selectedValue" label="module_name" placeholder="Select Controller"
			size="sm" />
	</div>
	<div class="mb-4">
		...
		<div class="d-flex justify-content-start gap-3">
			<div class="form-check">
				<input class="form-check-input" type="radio" name="position" id="topmenu" v-model="form.position"
					value="top" />
				<label class="form-check-label" for="topmenu"> Separator Menu </label>
			</div>
			<div class="form-check">
				<input class="form-check-input" type="radio" name="position" id="sidemenu" v-model="form.position"
					value="sidebar" />
	...
	<div class="mb-4">
		...
		<BInputGroup size="sm">
			...
			<BButton size="sm" text="Button" @click="modalIcons = true" variant="primary"><i
					class="bi bi-info-circle"></i></BButton>
		</BInputGroup>
		{{ modelValue }}
	</div>
	...
	<div class="mb-4">
		...
		<div class="d-flex justify-content-start gap-3">
			<div class="form-check">
				<input class="form-check-input" type="radio" name="status" id="active" v-model="form.active"
					value="1" />
				<label class="form-check-label" for="active"> Active </label>
			</div>
			<div class="form-check">
				<input class="form-check-input" type="radio" name="status" id="noneactive" v-model="form.active"
					value="0" />
	...
	<div class="mb-4">
		...
		<div class="d-flex justify-content-start gap-3">
			<div class="form-check" v-for="group in groups" :key="group.id">
				<input class="form-check-input" type="checkbox" :name="'access[' + group.group_id + ']'"
					:id="group.group_id" v-model="form.access_data[group.group_id]" :value="group.group_id"
					:checked="form.access_data[group.group_id] == 1" :true-value="1" :false-value="0" />
	...
	<div class="mb-4">
		...
		<div class="d-flex justify-content-start gap-3">
			<div class="form-check">
				<input class="form-check-input" type="checkbox" name="public" id="public" v-model="form.allow_guest"
